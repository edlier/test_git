<%@ Page Title="FQC List" Language="C#" MasterPageFile="~/QC/QC.master" AutoEventWireup="true" CodeBehind="FQC_List.aspx.cs" Inherits="misSystem.QC.FQC_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentQC" runat="server">
    ...
    <div class="Lp550-Tm325-georgia18px">
        <asp:GridView ID="grid_FQC" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical">
