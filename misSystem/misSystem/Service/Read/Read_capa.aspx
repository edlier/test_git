<%@ Page Title="" Language="C#" MasterPageFile="~/Service/ServiceMaster.master"AutoEventWireup="true" CodeBehind="Read_capa.aspx.cs" Inherits="misSystem.Service.Read_capa" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

        <title>MIS - CAPA_information</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentForService" runat="server">
    ...
    <div class="Lp550_Tm5_gradient40px">CAPA資訊</div>
    ...
    <div class="Lp550-Tm325-georgia18px">
        ...
        <br />
        <br />
        <asp:Label ID="Label8" runat="server" Text="Validation Detail：" Font-Bold="true"></asp:Label>
        <br />
        <br />
        <asp:TextBox ID="validation" runat="server" Height="150px" Width="400px" TextMode="MultiLine" ReadOnly="true"></asp:TextBox>
        <br />
        <br />
        <br />
