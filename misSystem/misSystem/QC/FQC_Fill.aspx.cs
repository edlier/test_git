...
{
    public partial class FQC_Fill : System.Web.UI.Page
    {
        ...
        {
            DataTable dt_validateFQC=GlobalAnnounce.QCList.search_FQC_DuplicateSN(tb_SN.Text);
            if (tb_SN.Text == "")
            {
            ...
            else if (dt_validateFQC.Rows.Count != 0)
            {
            ...
            else
            {
                ...
                GlobalAnnounce.QCList.insertFQC_data(
                    tb_SN.Text,
