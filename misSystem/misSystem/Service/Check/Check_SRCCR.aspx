<%@ Page Title="" Language="C#" MasterPageFile="~/Service/ServiceMaster.master"AutoEventWireup="true" CodeBehind="Check_SRCCR.aspx.cs" Inherits="misSystem.Service.Check_SRCCR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title>MIS - SRC主席 Close CR</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentForService" runat="server">
    ...
    <div class="Lp550_Tm5_gradient40px">SRC主席 Close CR</div>
