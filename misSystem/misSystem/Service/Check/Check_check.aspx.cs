...
{
    public partial class Check_check : System.Web.UI.Page
    {
        ...
        protected void btn_set_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (flow.Rows[0]["flow"].ToString() == "12")
                {
                    if (yes.Checked == true)
                    {
                        GlobalAnnounce.serviceDB.updateflow(13, id);
                        GlobalAnnounce.serviceDB.updatecapa(1, id);
                    }
                    else if (no.Checked == true)
                    {
                        GlobalAnnounce.serviceDB.updateflow(132, id);
                        GlobalAnnounce.serviceDB.updatecapa(0, id);
                    }
