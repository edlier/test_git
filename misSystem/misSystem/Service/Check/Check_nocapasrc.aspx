<%@ Page Title="" Language="C#" MasterPageFile="~/Service/ServiceMaster.master" AutoEventWireup="true" CodeBehind="Check_nocapasrc.aspx.cs" Inherits="misSystem.Service.check_nocapasrc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title>MIS - (NO CAPA)SRC結案審核</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentForService" runat="server">
    ...
    <div class="Lp550_Tm5_gradient40px">(NO CAPA)SRC結案審核</div>
