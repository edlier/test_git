<%@ Page Title="" Language="C#" MasterPageFile="~/Service/ServiceMaster.master" AutoEventWireup="true" CodeBehind="Check_check.aspx.cs" Inherits="misSystem.Service.Check_check" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentForService" runat="server">
    ...
    <div class="Lp550_Tm5_gradient40px">審查</div>
    ...
    <div class="Lp550-Tm325-georgia18px">
        ...
        <br />
        <br />
        <asp:Label ID="Label2" runat="server" Text="SPI No：" Font-Bold="true"></asp:Label>
        <asp:Label ID="spi" runat="server"  ></asp:Label>
        <br />
        <br />
        <asp:Label ID="Label14" runat="server" Text="Tracking No：" Font-Bold="true"></asp:Label>
        ...
        <br />
        <br />
        <asp:Label ID="Label1" runat="server" Text="Need CAPA ?"></asp:Label>
        <br />
        <br />
        <br />
        <asp:RadioButton ID="yes" GroupName="M" runat="server" Text="Yes." Checked="true" />
        &nbsp;&nbsp;&nbsp;
        <asp:RadioButton ID="no" GroupName="M" runat="server" Text="No." />
        <br />
        <br />
        <br />
