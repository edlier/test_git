<%@ Page Title="" Language="C#" MasterPageFile="~/Service/ServiceMaster.master" AutoEventWireup="true" CodeBehind="Check_QC.aspx.cs" Inherits="misSystem.Service.Check_QC" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

        <title>MIS - 結案品保主管確認</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentForService" runat="server">
    ...
    <div class="Lp550_Tm5_gradient40px">結案品保主管確認</div>
