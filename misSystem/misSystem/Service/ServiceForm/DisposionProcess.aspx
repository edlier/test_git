<%@ Page Title="" Language="C#" MasterPageFile="~/Service/ServiceMaster.master" AutoEventWireup="true" CodeBehind="DisposionProcess.aspx.cs" Inherits="misSystem.Service.DisposionProcess" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>MIS - Disposion Process</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentForService" runat="server">
        ...
        <div class="Lp550_Tm5_gradient40px">Disposion Process</div>
    ...
    <div class="Lp550-Tm325-georgia18px">
        ...
        <asp:TextBox ID="fr8dcr" runat="server" ReadOnly="true" ></asp:TextBox>
        <br />
        <br />
        <br />
        ...
        <asp:TextBox ID="vpmsg" runat="server" ReadOnly="true" ></asp:TextBox>
        <br />
        <br />
        <hr  style="height:5px" noshade="noshade" />
        <br />

        <asp:Label ID="lbl_Name" runat="server" Text="Disposion Process：" ></asp:Label>
        <br />
        <br />
        <asp:RadioButton ID="dp1" GroupName="DP" runat="server" Text="Returned reworked" Checked="true" />
        <br />
        <br />
        <asp:RadioButton ID="dp2" GroupName="DP" runat="server" Text="Restock" />
        <br />
        <br />
        <asp:RadioButton ID="dp3" GroupName="DP" runat="server" Text="Disposed" />
        <br />
        <br />
        <br />
        <br />
        <asp:Label ID="Label4" runat="server" Text="Returned Information："></asp:Label>
        <br />
        <br />
        
         <asp:UpdatePanel ID="UpdatePanel12" runat="server">
            <ContentTemplate>
                <asp:Label ID="Label9" runat="server" Text="Shipped out date："></asp:Label>
        ...
        <br />
        <asp:Label ID="Label10" runat="server" Text="Chargeable："></asp:Label>
        <asp:RadioButton ID="cc1" GroupName="M" runat="server" Text="Yes" Checked="true" />
        <asp:TextBox ID="chargeablemsg" runat="server" ></asp:TextBox>
        <asp:RadioButton ID="cc2" GroupName="M" runat="server" Text="No" />
        <br />
        <br />
        <asp:Label ID="Label1" runat="server" Text="SPI No："></asp:Label>
        <asp:TextBox ID="spi" runat="server" ></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label2" runat="server" Text="Tracking No："></asp:Label>
