<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="HR_check_proxy.aspx.cs" Inherits="misSystem.HR.HR_check_proxy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="out_div" style="top:161px;">
        ...
        <asp:Label ID="title_lab" runat="server" Text="代理人審核" style="font-style:italic; font-weight:bold;"></asp:Label><br />
