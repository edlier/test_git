<%@ Page Title="" Language="C#" MasterPageFile="~/Service/ServiceMaster.master"AutoEventWireup="true" CodeBehind="Check_PE.aspx.cs" Inherits="misSystem.Service.Check_PE" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title>MIS - PE manager reviewed</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentForService" runat="server">
    ...
    <div class="Lp550_Tm5_gradient40px">PE manager reviewed</div>
